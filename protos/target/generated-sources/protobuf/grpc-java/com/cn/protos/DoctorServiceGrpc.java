...
public final class DoctorServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.cn.protos.DoctorGetRequest,
      com.cn.protos.DoctorGetResponse> getGetDoctorDetailsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetDoctorDetails",
      requestType = com.cn.protos.DoctorGetRequest.class,
      responseType = com.cn.protos.DoctorGetResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.cn.protos.DoctorGetRequest,
      com.cn.protos.DoctorGetResponse> getGetDoctorDetailsMethod() {
    io.grpc.MethodDescriptor<com.cn.protos.DoctorGetRequest, com.cn.protos.DoctorGetResponse> getGetDoctorDetailsMethod;
    if ((getGetDoctorDetailsMethod = DoctorServiceGrpc.getGetDoctorDetailsMethod) == null) {
      synchronized (DoctorServiceGrpc.class) {
        if ((getGetDoctorDetailsMethod = DoctorServiceGrpc.getGetDoctorDetailsMethod) == null) {
          DoctorServiceGrpc.getGetDoctorDetailsMethod = getGetDoctorDetailsMethod =
              io.grpc.MethodDescriptor.<com.cn.protos.DoctorGetRequest, com.cn.protos.DoctorGetResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetDoctorDetails"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cn.protos.DoctorGetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.cn.protos.DoctorGetResponse.getDefaultInstance()))
              .setSchemaDescriptor(new DoctorServiceMethodDescriptorSupplier("GetDoctorDetails"))
              .build();
        }
      }
    }
    return getGetDoctorDetailsMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getDoctorDetails(com.cn.protos.DoctorGetRequest request,
        io.grpc.stub.StreamObserver<com.cn.protos.DoctorGetResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetDoctorDetailsMethod(), responseObserver);
    }
  }
  ...
  public static final class DoctorServiceStub
    ...
    /**
     */
    public void getDoctorDetails(com.cn.protos.DoctorGetRequest request,
        io.grpc.stub.StreamObserver<com.cn.protos.DoctorGetResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetDoctorDetailsMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class DoctorServiceBlockingStub
    ...
    /**
     */
    public com.cn.protos.DoctorGetResponse getDoctorDetails(com.cn.protos.DoctorGetRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getGetDoctorDetailsMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class DoctorServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.cn.protos.DoctorGetResponse> getDoctorDetails(
        com.cn.protos.DoctorGetRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getGetDoctorDetailsMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_GET_DOCTOR_DETAILS = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_DOCTOR_DETAILS:
          serviceImpl.getDoctorDetails((com.cn.protos.DoctorGetRequest) request,
              (io.grpc.stub.StreamObserver<com.cn.protos.DoctorGetResponse>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          getGetDoctorDetailsMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.cn.protos.DoctorGetRequest,
              com.cn.protos.DoctorGetResponse>(
                service, METHODID_GET_DOCTOR_DETAILS)))
        .build();
  }
  ...
  private static abstract class DoctorServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.cn.protos.Doctor.getDescriptor();
    }
      ...
      synchronized (DoctorServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getGetDoctorDetailsMethod())
              .build();
        }
      }
    }
